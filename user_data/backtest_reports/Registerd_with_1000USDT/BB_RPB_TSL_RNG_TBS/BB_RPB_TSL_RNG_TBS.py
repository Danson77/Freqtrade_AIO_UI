...
############################################################################
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Apply the tags for the exit conditions
        dataframe.loc[exit_condition_1, 'exit_tag'] = 'exit_condition_1'
        dataframe.loc[exit_condition_2, 'exit_tag'] = 'exit_condition_2'

        # Combine the conditions for the final 'exit_long' column
        dataframe.loc[exit_condition_1 | exit_condition_2, 'exit_long'] = 1
