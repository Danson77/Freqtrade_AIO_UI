...
##                                                                                                       ##
##   For optimal performance, suggested to use between 4 and 6 open trades, unlimited stake.             ##
##                                                                                                       ##
...
##                                                                                                       ##
##   Ensure that you don't override any variables in you config.json.                                    ##
##   The timeframe (must be 5m).                                                                         ##
##                                                                                                       ##
##     use_exit_signal = true (or not set at all).                                                       ##
##     exit_profit_only = false (or not set at all).                                                     ##
##     ignore_roi_if_entry_signal = true (or not set at all).                                            ##
##                                                                                                       ##
###########################################################################################################
...
########################################################################################################################################################
    ...
    ignore_roi_if_entry_signal = True  # If True, ignore ROI when the buy signal is still present.
    # Custom stoploss configuration.
    use_custom_stoploss = False  # Whether to use a custom stoploss function.
    # Trailing stop configuration.
    trailing_stop = True
    trailing_stop_positive = 0.005  # Positive offset for trailing stop.
    trailing_stop_positive_offset = 0.03  # Offset for triggering the trailing stop.
...
########################################################################################################################################################
    def normal_tf_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Zero-Lag EMA
        dataframe['dema'] = ta.DEMA(dataframe['close'], timeperiod=100)
...
########################################################################################################################################################
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Populate buy_01_trigger and tag
        dataframe.loc[:, 'buy_01_trigger'] = reduce(lambda x, y: x & y, buy_01_logic)
        # Tagging buy_01
        dataframe.loc[dataframe['buy_01_trigger'], 'enter_tag'] = dataframe.loc[dataframe['buy_01_trigger'], 'enter_tag'] + 'buy_01 '
        ...
        # Populate buy_02_trigger and tag
        dataframe.loc[:, 'buy_02_trigger'] = reduce(lambda x, y: x & y, buy_02_logic)
        # Tagging buy_02
        dataframe.loc[dataframe['buy_02_trigger'], 'enter_tag'] = dataframe.loc[dataframe['buy_02_trigger'], 'enter_tag'] + 'buy_02 '
        ...
        # Populate buy_03_trigger and tag
        dataframe.loc[:, 'buy_03_trigger'] = reduce(lambda x, y: x & y, buy_03_logic)
        # Tagging buy_03
        dataframe.loc[dataframe['buy_03_trigger'], 'enter_tag'] = dataframe.loc[dataframe['buy_03_trigger'], 'enter_tag'] + 'buy_03 '
        ...
        # Populate buy_04_trigger and tag
        dataframe.loc[:, 'buy_04_trigger'] = reduce(lambda x, y: x & y, buy_04_logic)
        # Tagging buy_04
        dataframe.loc[dataframe['buy_04_trigger'], 'enter_tag'] = dataframe.loc[dataframe['buy_04_trigger'], 'enter_tag'] + 'buy_04 '
        ...
        # Populate buy_05_trigger and tag
        dataframe.loc[:, 'buy_05_trigger'] = reduce(lambda x, y: x & y, buy_05_logic)
        # Tagging buy_05
        dataframe.loc[dataframe['buy_05_trigger'], 'enter_tag'] = dataframe.loc[dataframe['buy_05_trigger'], 'enter_tag'] + 'buy_05 '
        ...
        # Populate buy_06_trigger and tag
        dataframe.loc[:, 'buy_06_trigger'] = reduce(lambda x, y: x & y, buy_06_logic)
        # Tagging buy_06
        dataframe.loc[dataframe['buy_06_trigger'], 'enter_tag'] = dataframe.loc[dataframe['buy_06_trigger'], 'enter_tag'] + 'buy_06 '
        ...
        # Populate buy_07_trigger and tag
        dataframe.loc[:, 'buy_07_trigger'] = reduce(lambda x, y: x & y, buy_07_logic)
        # Tagging buy_07
        dataframe.loc[dataframe['buy_07_trigger'], 'enter_tag'] = dataframe.loc[dataframe['buy_07_trigger'], 'enter_tag'] + 'buy_07 '
        ...
        # Populate buy_08_trigger and tag
        dataframe.loc[:, 'buy_08_trigger'] = reduce(lambda x, y: x & y, buy_08_logic)
        # Tagging buy_08
        dataframe.loc[dataframe['buy_08_trigger'], 'enter_tag'] = dataframe.loc[dataframe['buy_08_trigger'], 'enter_tag'] + 'buy_08 '
        ...
        # Populate buy_09_trigger and tag
        dataframe.loc[:, 'buy_09_trigger'] = reduce(lambda x, y: x & y, buy_09_logic)
        # Tagging buy_09
        dataframe.loc[dataframe['buy_09_trigger'], 'enter_tag'] = dataframe.loc[dataframe['buy_09_trigger'], 'enter_tag'] + 'buy_09 '
        ...
        # Populate buy_10_trigger and tag
        dataframe.loc[:, 'buy_10_trigger'] = reduce(lambda x, y: x & y, buy_10_logic)
        # Tagging buy_10
        dataframe.loc[dataframe['buy_10_trigger'], 'enter_tag'] = dataframe.loc[dataframe['buy_10_trigger'], 'enter_tag'] + 'buy_10 '
        ...
        # Populate buy_11_trigger and tag
        dataframe.loc[:, 'buy_11_trigger'] = reduce(lambda x, y: x & y, buy_11_logic)
        # Tagging buy_11
        dataframe.loc[dataframe['buy_11_trigger'], 'enter_tag'] = dataframe.loc[dataframe['buy_11_trigger'], 'enter_tag'] + 'buy_11 '
        ...
        # Populate buy_12_trigger and tag
        dataframe.loc[:, 'buy_12_trigger'] = reduce(lambda x, y: x & y, buy_12_logic)
        # Tagging buy_12
        dataframe.loc[dataframe['buy_12_trigger'], 'enter_tag'] = dataframe.loc[dataframe['buy_12_trigger'], 'enter_tag'] + 'buy_12 '
        ...
        # Populate buy_13_trigger and tag
        dataframe.loc[:, 'buy_13_trigger'] = reduce(lambda x, y: x & y, buy_13_logic)
        # Tagging buy_13
        dataframe.loc[dataframe['buy_13_trigger'], 'enter_tag'] = dataframe.loc[dataframe['buy_13_trigger'], 'enter_tag'] + 'buy_13 '
        ...
        # Populate buy_14_trigger and tag
        dataframe.loc[:, 'buy_14_trigger'] = reduce(lambda x, y: x & y, buy_14_logic)
        # Tagging buy_14
        dataframe.loc[dataframe['buy_14_trigger'], 'enter_tag'] = dataframe.loc[dataframe['buy_14_trigger'], 'enter_tag'] + 'buy_14 '
        ...
        # Populate buy_15_trigger and tag
        dataframe.loc[:, 'buy_15_trigger'] = reduce(lambda x, y: x & y, buy_15_logic)
        # Tagging buy_15
        dataframe.loc[dataframe['buy_15_trigger'], 'enter_tag'] = dataframe.loc[dataframe['buy_15_trigger'], 'enter_tag'] + 'buy_15 '
        ...
        # Populate buy_16_trigger and tag
        dataframe.loc[:, 'buy_16_trigger'] = reduce(lambda x, y: x & y, buy_16_logic)
        # Tagging buy_16
        dataframe.loc[dataframe['buy_16_trigger'], 'enter_tag'] = dataframe.loc[dataframe['buy_16_trigger'], 'enter_tag'] + 'buy_16 '
        ...
        # Populate buy_17_trigger and tag
        dataframe.loc[:, 'buy_17_trigger'] = reduce(lambda x, y: x & y, buy_17_logic)
        # Tagging buy_17
        dataframe.loc[dataframe['buy_17_trigger'], 'enter_tag'] = dataframe.loc[dataframe['buy_17_trigger'], 'enter_tag'] + 'buy_17 '
        ...
        # Populate buy_18_trigger and tag
        dataframe.loc[:, 'buy_18_trigger'] = reduce(lambda x, y: x & y, buy_18_logic)
        # Tagging buy_18
        dataframe.loc[dataframe['buy_18_trigger'], 'enter_tag'] = dataframe.loc[dataframe['buy_18_trigger'], 'enter_tag'] + 'buy_18 '
        ...
        # Populate buy_19_trigger and tag
        dataframe.loc[:, 'buy_19_trigger'] = reduce(lambda x, y: x & y, buy_19_logic)
        # Tagging buy_19
        dataframe.loc[dataframe['buy_19_trigger'], 'enter_tag'] = dataframe.loc[dataframe['buy_19_trigger'], 'enter_tag'] + 'buy_19 '
        ...
        # Populate buy_20_trigger and tag
        dataframe.loc[:, 'buy_20_trigger'] = reduce(lambda x, y: x & y, buy_20_logic)
        # Tagging buy_20
        dataframe.loc[dataframe['buy_20_trigger'], 'enter_tag'] = dataframe.loc[dataframe['buy_20_trigger'], 'enter_tag'] + 'buy_20 '
        ...
        # Populate buy_21_trigger and tag
        dataframe.loc[:, 'buy_21_trigger'] = reduce(lambda x, y: x & y, buy_21_logic)
        # Tagging buy_21
        dataframe.loc[dataframe['buy_21_trigger'], 'enter_tag'] = dataframe.loc[dataframe['buy_21_trigger'], 'enter_tag'] + 'buy_21 '
        ...
        # Populate buy_22_trigger and tag
        dataframe.loc[:, 'buy_22_trigger'] = reduce(lambda x, y: x & y, buy_22_logic)
        # Tagging buy_22
        dataframe.loc[dataframe['buy_22_trigger'], 'enter_tag'] = dataframe.loc[dataframe['buy_22_trigger'], 'enter_tag'] + 'buy_22 '
        ...
        # Populate buy_23_trigger and tag
        dataframe.loc[:, 'buy_23_trigger'] = reduce(lambda x, y: x & y, buy_23_logic)
        # Tagging buy_23
        dataframe.loc[dataframe['buy_23_trigger'], 'enter_tag'] = dataframe.loc[dataframe['buy_23_trigger'], 'enter_tag'] + 'buy_23 '
        ...
        # Populate buy_24_trigger and tag
        dataframe.loc[:, 'buy_24_trigger'] = reduce(lambda x, y: x & y, buy_24_logic)
        # Tagging buy_24
        dataframe.loc[dataframe['buy_24_trigger'], 'enter_tag'] = dataframe.loc[dataframe['buy_24_trigger'], 'enter_tag'] + 'buy_24 '
        ...
        # Populate buy_26_trigger and tag
        dataframe.loc[:, 'buy_26_trigger'] = reduce(lambda x, y: x & y, buy_26_logic)
        # Tagging buy_26
        dataframe.loc[dataframe['buy_26_trigger'], 'enter_tag'] = dataframe.loc[dataframe['buy_26_trigger'], 'enter_tag'] + 'buy_26 '
