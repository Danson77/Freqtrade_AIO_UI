...
class E0V1E_16(IStrategy):
    ...
    def custom_exit(self, pair: str, trade: Trade, current_time: datetime, current_rate: float, current_profit: float, **kwargs) -> Optional[Union[str, bool]]:
        ...
        if (
            ...
            (current_candle['bb_width'] < self.sell_deadfish_bb_width.value) &
            (current_candle['close'] > current_candle['bb_middleband2'] * self.sell_deadfish_bb_factor.value) &
    ...
    def custom_stoploss(self, pair: str, trade: Trade, current_time: datetime, current_rate: float, current_profit: float, **kwargs) -> float:
        ...
        enter_tag = trade.enter_tag if hasattr(trade, 'enter_tag') and trade.enter_tag else ''
        ...
        if current_profit > 0:
            if current_candle['fastk'] > self.sell_fastx.value or current_candle['rsi'] > 80:
                return -0.001


        if current_profit < 0 and current_candle['rsi'] > 90:
            return -0.001
